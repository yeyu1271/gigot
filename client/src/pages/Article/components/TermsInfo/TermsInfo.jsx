    ...
    return (
      <IceContainer>
        ...
        <p style={styles.info}>
          ...
          <span style={{ marginLeft: 20 }}>作者：gigot</span>
          <span style={{ marginLeft: 20 }}>时间：{fecha.format(this.state.time, 'MMM D YYYY')}</span>
        </p>
        <div
        ...
        <p>
          <Link to="/article" style={{ paddingLeft: 30 }}>上一章：浅出JavaScript</Link>
          <Link style={{ float: 'right', paddingRight: 30 }} to="/article">下一章：深入JavaScript</Link>
        </p>
